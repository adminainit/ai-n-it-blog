...
## 12. Admin Portal Security
The admin portal at `http://localhost:3000/admin/` is protected by a login screen. 
- **Default Password**: `admin`

To change the password, update `adminPassword` in `site.config.js`. Note that since the deployment process exclusively publishes the `dist` folder, the admin portal code and data will **never** be uploaded to the public GitHub repository.
