...
import { Edit3, Trash2, Plus, Settings, Eye, EyeOff, FileText, Upload, X, Palette, Bold, Italic, Link as LinkIcon, Save, Rocket, BookOpen, Copy, Check, Activity, CheckCircle, XCircle, RefreshCw } from 'lucide-react';
...
export default function AdminDashboard({ posts, onEditPost, onDeletePost, syncStatus, isSyncing, syncToBackend, savePostLocal }: any) {
  const [activeTab, setActiveTab] = useState<'posts' | 'settings' | 'deploy' | 'docs'>('posts');
