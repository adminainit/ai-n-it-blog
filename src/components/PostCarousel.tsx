      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="md:w-2/5 p-6 lg:p-8 flex flex-col justify-center gap-3">
            ...
            <a href={`/blog/${currentPost.id}`} className="block">
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <a href={`/blog/${currentPost.id}`} className="text-[11px] font-bold text-indigo-600 dark:text-indigo-400 hover:underline flex items-center gap-1">
                Read Article
              </a>
            </div>
          </div>
